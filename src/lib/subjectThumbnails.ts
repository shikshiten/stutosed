...
export const SUBJECT_KEYS = {
  ...
  ENG_PRACTICE_31: 'english_practice_31',
  REASONING_SPL_58: 'reasoning_spl_58',
  MATHS_SPECIAL_1: 'maths_special_1',
  AARAMBH_BATCH_100HR_SW: 'aarambh_batch_100hr_sw',
  MATHS_SPECIAL_VOD_2: 'maths_special_vod_2',
  SELECTION_BATCH_1: 'selection_batch_1',
  SSC_COMPLETE_VOD: 'ssc_complete_vod',
...
export const BATCH_SUBJECT_MAP: Record<string, string> = {
  ...
  'eng-practice-31': SUBJECT_KEYS.ENG_PRACTICE_31,
  'eng-practice-31-turbo': SUBJECT_KEYS.ENG_PRACTICE_31,
  'reasoning-spl-58': SUBJECT_KEYS.REASONING_SPL_58,
  'maths-special-1': SUBJECT_KEYS.MATHS_SPECIAL_1,
  'maths-special-1-loki': SUBJECT_KEYS.MATHS_SPECIAL_1,
  'aarambh-batch-100hr-sw': SUBJECT_KEYS.AARAMBH_BATCH_100HR_SW,
  'maths-special-vod-2': SUBJECT_KEYS.MATHS_SPECIAL_VOD_2,
  'loki-maths-special-vod-2': SUBJECT_KEYS.MATHS_SPECIAL_VOD_2,
  'selection-batch-1': SUBJECT_KEYS.SELECTION_BATCH_1,
  'selection-batch-1-loki': SUBJECT_KEYS.SELECTION_BATCH_1,
  'ssc-complete-vod': SUBJECT_KEYS.SSC_COMPLETE_VOD,
  'loki-ssc-complete-vod': SUBJECT_KEYS.SSC_COMPLETE_VOD,
